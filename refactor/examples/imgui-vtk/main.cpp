...
int main(int argc, char* argv[])
{
    ...
    GLFWwindow* window = glfwCreateWindow(1280, 720, "Cam Viewer Example", nullptr, nullptr);
    if (window == nullptr) {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // to created a named window.
        {
            ...
            if (ImGui::CollapsingHeader("CAM example", ImGuiTreeNodeFlags_DefaultOpen)) {
                    ...
                    if (camModel.cutter && camModel.surface) {
                        ...
                        switch (op_type_index) {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                adaptivePathDropCutter(camModel,
                                                       sampling,
                                                       min_sampling,
                                                       &camViewer);
                                break;
            ...
            if (ImGui::TreeNodeEx("WorkPieces", ImGuiTreeNodeFlags_DefaultOpen)) {
                if (auto model = camViewer.modelActor) {
                    ...
                    if (ImGui::SliderScalar("Transparency",
