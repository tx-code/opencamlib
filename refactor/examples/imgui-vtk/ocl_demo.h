...
void waterline(const ocl::STLSurf &surface, ocl::MillingCutter *cutter,
               double z, double sampling, VtkViewer *viewer = nullptr,
               double lift_step = 0.1, double lift_from = 0.0,
               bool verbose = false) {
...
void adaptivePathDropCutter(const ocl::STLSurf &surface,
                            ocl::MillingCutter *cutter, double sampling,
                            double minSampling, ocl::Path *path,
                            VtkViewer *viewer = nullptr) {
  spdlog::stopwatch sw;
