...
public:
  ...
  void matrixRotate(double a, double b, double c, double d, double e, double f,
  ...
  /// returns true if point is right of line through p1 and p2 (works in the
  /// XY-plane)
  ...
  Point &
  operator*=(const double &a); // scalar multiplication with Point *= scalar
  /// Point * scalar
