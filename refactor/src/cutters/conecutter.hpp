...
class OCL_API ConeCutter : public MillingCutter {
public:
  ConeCutter();
  ...
  /// Cone facet-drop is special, since we can make contact with either the tip
  /// or the circular rim
...
protected:
  ...
  bool circle_CC(double t, const Point &p1, const Point &p2, const Fiber &f,
                 Interval &i) const;
  bool cone_CC(const Point &tang, const Point &tip, const Point &base,
