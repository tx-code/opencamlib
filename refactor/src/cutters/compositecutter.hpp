...
class OCL_API CompositeCutter : public MillingCutter {
public:
  ...
  /// call edgeDrop on each cutter and pick the correct (highest valid CL-point)
  /// result
...
/// \brief CompositeCutter with a cylindrical/flat central part of diameter
/// diam1 and a conical outer part sloping at angle, with a max diameter diam2
...
/// the cone is positioned so that the tangent of the cone matches the tangent
/// of the sphere
...
public:
  ...
  /// create cone-cone cutter with lower cone (diam1,angle1) and upper cone
  /// (diam2,angle2) we assume angle2 < angle1  and  diam2 > diam1.
