...
public:
  ...
  /// update interval with t_cl and cc_tmp if cc_tmp is in the p1-p2 edge and
  /// condition==true
  bool update_ifCCinEdgeAndTrue(double t_cl, CCPoint &cc_tmp, const Point &p1,
  ...
  CCPoint upper_cc; ///< cutter contact points at upper and lower are stored in
                    ///< upper_cc and lower_cc
  ...
  // this is the same type as ocl::weave::VertexPairIterator, but redefined here
  // anywhere
